...
export default Tour2=({navigation})=>{
  return(
    ...
    <TouchableHighlight style={{backgroundColor:"#289e35",width:60,height:60,justifyContent:"center",alignItems:"center",marginTop:20,borderColor:"white",borderWidth:2}}  onPress={()=>navigation.navigate('Drawer')}>
